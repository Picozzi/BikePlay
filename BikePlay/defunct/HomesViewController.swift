...
//}
//
//extension HomesViewController: CLLocationManagerDelegate {
...
//
//
//extension HomesViewController: HandleMapSearch {
//    func dropPinZoomIn(placemark:MKPlacemark){
//
...
//}
//
//extension HomesViewController: SelectAlternateRoute {
//    func showAlternate(selectedRoute:MKRoute, index: Int){
//        mapView.removeOverlays(mapView.overlays)
//
//        for route in routes {
...
//extension HomesViewController: StartRoute {
//    func startButtonPressed(index:Int)
//    {
//        //CLEAR MAP
//        mapView.removeOverlays(mapView.overlays)
...
//
//
//extension HomesViewController: MKMapViewDelegate {
